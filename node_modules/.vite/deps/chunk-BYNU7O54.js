...
function useForkRef(...refs) {
  ...
  const refEffect = React13.useCallback((instance) => {
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider(props) {
    ...
    const memoTheme2 = React34.useMemo(() => {
      var _a2;
...
var SvgIcon = React42.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = React42.isValidElement(children) && children.type === "svg";
  const ownerState = {
    ...props,
    color: color2,
    component,
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-BYNU7O54.js.map
